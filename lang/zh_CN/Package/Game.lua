return {
	...
	["guangyu"] = "光玉",
	[":guangyu"] = "每当你弃置的♥牌进入弃牌堆后，你可以将之置入一名角色的判定区，称为“键”。判定区有“键”的角色的判定阶段开始时，你可以将其判定区里的一张“键”置入弃牌堆，然后令其获得判定区里的所有牌。\n“键”：当一名角色判定区里的这张牌移动后，该角色回复1点体力。",
	...
	["xiaying"] = "夏影",
	[":xiaying"] = "准备阶段开始时，与你势力相同的其他角色可以依次交给你任意数量的手牌，若以此法交给你的牌的张数不多于X张（X为与你势力相同的其他角色的数量），你失去1点体力。",
