return {
	...
	["guangyu"] = "光玉",
	[":guangyu"] = "每当你弃置的♥牌进入弃牌堆后，你可以将之置入一名角色的判定区，称为“键”。判定区有“键”的角色的判定阶段开始时，你可以将其判定区里的所有牌置入弃牌堆。",
	["@guangyu-put"] = "请指定一名角色，将弃置的♥牌当“键”置入其判定区",
	...
	["taozui"] = "陶醉",
	[":taozui"] = "你可以跳过判定阶段和摸牌阶段，将一名角色判定区里的一张牌置入弃牌堆，然后将牌堆顶牌置入其判定区，称为“键”。",
	...
	["jiuzhu"] = "救助",
	[":jiuzhu"] = "当一名角色处于濒死状态时，若其判定区里没有“键”，你可以将牌堆顶牌置于该角色的判定区，称为“键”。每当一名角色失去体力时，你可以将其判定区内的一张“键”置入弃牌堆。每当一张“键”进入弃牌堆时，你摸一张牌。",
