return {
	...
	["zhiyanmiki"] = "直言",
	[":zhiyanmiki"] = "锁定技，回合结束时，若你于此回合内跳过了至少一个阶段，你选择一项：摸一张牌，或弃置一名角色区域里的一张牌。",
	["$zhiyanmiki"] = "",
	...
	["guangyu"] = "光玉",
	[":guangyu"] = "每当你弃置的♥牌进入弃牌堆后，你可以将之置入一名角色的判定区，称为“键”。判定区有“键”的未受伤角色的判定阶段开始时，其获得判定区里的所有牌。\n“键”：当一名角色判定区里的这张牌移动后，该角色回复1点体力。",
	...
	["taozui"] = "陶醉",
	[":taozui"] = "你可以跳过判定阶段和摸牌阶段，将场上一张【乐不思蜀】或【兵粮寸断】置入弃牌堆。",
