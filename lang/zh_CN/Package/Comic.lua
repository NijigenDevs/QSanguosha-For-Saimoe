return {
	...
	["fengyin"] = "封印",
	[":fengyin"] = "当你于出牌阶段内使用的【杀】对与你势力不同的目标角色造成伤害时，若目标角色有副将的武将牌，你可以防止此伤害，令其移除副将的武将牌，每回合限一次。",
	...
	["kaihua"] = "开花",
	[":kaihua"] = "出牌阶段限一次，你可以弃置X枚“杠”标记（X为本局游戏中你已发动“开花”次数，且至少为1），然后指定任意数量的的其他角色，令这些角色各选择一项：\n1、交给你一张装备牌；\n2、你回复1点体力；\n3、受到你对其造成的1点伤害。",
	...
	["suanlv"] = "算率",
	[":suanlv"] = "其他角色的弃牌阶段开始时，你可以将至多X张手牌背面朝上置于你的武将牌上（X为你已损失的体力值），称为“算”。其他角色的弃牌阶段结束时，你弃置所有的“算”，然后获得所有于此阶段内弃置的与“算”中任意一张牌花色相同的牌。",
