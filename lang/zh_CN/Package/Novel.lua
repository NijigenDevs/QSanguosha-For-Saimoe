return {
	...
	["lingjie"] = "零界",
	[":lingjie"] = "出牌阶段限一次，你可以横置与你势力相同的和一个与你不同的势力的所有角色的副将的武将牌，然后摸等同于两者之差的张数的牌（至多为3）。",
	["#LingjieChain"] = "%from 的 “%arg” 生效，横置了 %to",

	["xuwu"] = "虚无",
	[":xuwu"] = "出牌阶段，或每当你受到一次伤害后，你可以重铸一张装备牌。",
	...
	["@jisui-exchange"] = "你可以选择一张手牌，然后与“稷穗”展示的一张牌交换",
