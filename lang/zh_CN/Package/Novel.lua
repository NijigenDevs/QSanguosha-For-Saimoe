return {
	...
	["bianchi"] = "鞭笞",
	[":bianchi"] = "出牌阶段限一次，你可以对一名攻击范围内的其他角色造成一点伤害，然后令其摸X张牌。若该角色因此而进入濒死阶段，将你的武将牌翻面。X为该角色失去的体力值。",	
	...
	["duran"] = "独然",
	[":duran"] = "锁定技，体力上限多于你的角色与你的距离+1，你与体力上限少于你的角色的距离+1。出牌阶段开始时，你摸X张牌（X 为攻击范围内没有你的其他势力数）。",
	...
	["drawonecard"] = "摸一张牌",
	["showonegeneral"] = "明置一张武将牌",
	["xianli:knownboth"] = "视为被使用一张【知己知彼】",

	["yuanxin"] = "援心",
	[":yuanxin"] = "副将技，其他角色的结束阶段开始时，若你于此回合内出牌阶段回复了至少1点体力，你可以失去1点体力，令一名其他角色回复1点体力，然后你摸两张牌。",
	...
	["zhuanyu"] = "馔玉",
	[":zhuanyu"] = "出牌阶段限一次，你可以将一张“烁”置入弃牌堆，然后摸X张牌。X为你失去的体力值。",
	["shuo"] = "烁",
	...
	["zixun"] = "资讯",
	[":zixun"] = "锁定技，摸牌阶段，你改为摸X张牌（X 为你此武将明置的回合数，且至多为3）。",
	["@zixun"] = "资讯",
