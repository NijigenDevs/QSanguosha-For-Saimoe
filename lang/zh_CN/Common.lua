CommonTranslationTable = {
	...
	["global_effect"] = "全局效果",
	["aoe"] = "AOE",
	["single_target_trick"] = "单目标法术",
	["multiple_target_trick"] = "多目标法术",
	["delayed_trick"] = "延时法术",
	["buff_card"] = "辅助伤害",
	["damage_spread"] = "伤害传导",
	["weapon"] = "武器",
	...
	["#NullificationDetails"] = "【<font color=\"yellow\"><b>无懈可击</b></font>】的目标是 %from 对 %to 的法术 【%arg】",
	["#HegNullificationDetails"] = "【<font color=\"yellow\"><b>无懈可击·国</b></font>】的目标是 %from 对 %to 的法术 【%arg】",
	["#HegNullificationEffect"] = "【<font color=\"yellow\"><b>无懈可击·国</b></font>】生效， 目标是 %from 对 %to 的法术 【%arg】",
	...
	["$PasteCard"] = "%from 对 %to 使用延时法术 %card",
	...
	["#DelayedTrick"] = "%from 的延时法术【%arg】开始判定",
